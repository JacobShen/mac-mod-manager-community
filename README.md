# Mac Mod Manager Community

[English](#english) · [简体中文](#简体中文)

## English

Mac Mod Manager is a native macOS tool for importing, analyzing, converting,
organizing, installing, and safely removing compatible game Mods. The first
validated game module is **Resident Evil 4** for macOS.
...
- License, payment, refund, privacy, or a report containing personal data:
  email [support@macmodmanager.app](mailto:support@macmodmanager.app) instead of
...
Mac Mod Manager 是一款原生 macOS Mod 管理工具，用于导入、分析、转换、整理、
安装和安全移除兼容的游戏 Mod。首个完成验证的游戏模块是 macOS 版
**《生化危机 4》**。
...
- 许可证、付款、退款、隐私，或包含个人信息的报告：请发送邮件到
  [support@macmodmanager.app](mailto:support@macmodmanager.app)，不要提交公开 Issue。
